    ...
    return (
        <div>
            <div className="NEW-00">
                ...
                <button onClick={()=>handlealert("Hello my flowers")}> Go somewhere </button>
                <Figure>
                    <Figure.Image
                        width={171}
                        height={180}
                    ...
                    <Figure.Caption>
                        ...
                        <p>Salut tous le monde, je m'appelle {name} Atoui j'ai {age} ans je suis une fille très charmante, avec des joues rondes et des yeux vertes. je suis très gentille avec tout le monde. Je suis toujours avec mes amis pour ses supporter et pour ses montrer la meilleure solution quand ils ont des problèmes. Ce que j'aime à mes amies c'est l'honnêteté.</p>
